...
class CreditCardControllerTest {
    ...
    void findAll() throws Exception {
        mockMvc.perform(get("/credit-cards"))
                ...
                //.andExpect(jsonPath("$[0].status").value(creditCard.getStatus()))
                //.andExpect(jsonPath("$[0].accountType").value(creditCard.getAccountType()))
                ...
                //.andExpect(jsonPath("$[0].balance").value(creditCard.getBalance()))
    ...
    void findById() throws Exception {
        mockMvc.perform(get("/credit-cards/1"))
                ...
                //.andExpect(jsonPath("$.status").value(creditCard.getStatus()))
                //.andExpect(jsonPath("$.accountType").value(creditCard.getAccountType()))
                ...
                //.andExpect(jsonPath("$.balance").value(creditCard.getBalance()))
